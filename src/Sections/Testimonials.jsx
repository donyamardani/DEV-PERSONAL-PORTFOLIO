...
const previous=()=>{
  ...
  return (
    <section id='testimonials' className='py-2 relative overflow-hidden'>
       <div className='absolute top-1/2 left-1/2 w-[8000px] h-[8000px] bg-primary/5 rounded-full blur-3xl -translate-x-1/2 -translate-y-1/2'/>
            ...
            <div className='relative'>
              ...
              <div className='glass p-8 rounded-3xl md:p-12 glow-border animate-fade-in animation-delay-200'>
                ...
                <div className='flex items-center gap-4'>
                  <img className='w-14 h-14 rounded-full object-cover ring-2 ring-primary/20' src={testimonials[activeIdx].avatar} alt={testimonials[0].author} />
                </div>
                <div className='flex items-center gap-4 '>
          ...
          <div className='flex items-center justify-center gap-4 mt-8 '>
            ...
            <div className='flex gap-2 '>
              {testimonials.map((_,index)=>(
                <button key={index} onClick={()=>setActiveIdx(index)} className={`w-2 h-2 rounded-full transition-all duration-300 ${index===activeIdx?"w-8 bg-primary":"bg-muted-foreground/30"}`}/>
              ))}
            </div>
